...
|---|---:|---:|---|
| **Our layer `aibattle_*`** (behaviour) | **8,338** | 3.9% | YES - all the logic is here |
...
| File | lines | Role |
|---|---:|---|
| `aibattle_survive.lua` | 1318 | **Healing and low-HP regen**: `fountainRecovery`, `defensiveHeal`, `regenLane`, `recovery` (bottle / flask / tango / rune fallback chain, buy-escape). |
