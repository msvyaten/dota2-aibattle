...
- **Приёмка окна убийства выбрана неудачно.** `killwin-atk/exec/mutual` — `DiagRL(3s)`, дали
  0-4 за матч, из таких чисел не следует ничего. Переделать счётчик до следующей правки
  `Style.AttackDamageMult`.
