...
## 1. The AIBattle layer - our code (`bots/FunLib/aibattle_*.lua`, 8,338 lines, 22 files)
...
| `aibattle_item_policy.lua` | 198 | `ShouldUseMango`, `ShouldDelaySpareTpPurchase`, consumable guards for fountain trips. |
...
|---|---:|---:|---:|
| `bots/mode_laning_generic.lua` | 1691 | 286 | 17% |
| `bots/mode_roam_generic.lua` | 2209 | 42 | 1% |
| `bots/item_purchase_generic.lua` | 1418 | 31 | 2% |
| `bots/ability_item_usage_generic.lua` | 8510 | 23 | 0% |
...
| `check_all.py` | 768 | The repo gate: encoding, Lua/Python syntax, deploy manifest, live drift, schema contract, tests, inventory. |
...
| `check_schema_contract.py` | 146 | Python/Lua/prompt/config schema agreement, including the worked example the model copies. |
