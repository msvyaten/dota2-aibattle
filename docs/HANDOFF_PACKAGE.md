...
**Текущий этап — Этап 2 (продукт):** TOP-0 бенчмарк (OHA-дефолт vs наш лучший
конфиг, 1 матч, цифра прироста) → TOP-1 кластер лейн-контроля. Архетипы уже
дифференцируются: в 8881103277 pusher (`cw=push`) экономически задавил brawler'а
(LH 8 vs 29, у Dire не хватило золота на бутылку) и выиграл 2:0.
