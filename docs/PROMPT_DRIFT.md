...
> case-незаметно воспроизводит один архетип), четыре НОВЫХ архетипа помимо brawler/farmer/
> pusher (assassin, poke, lane bully, turtle) и раздел про реальный предиктор фарма.
